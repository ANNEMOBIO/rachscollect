...
const Features = () => {
  ...
  const handleSeeMore = () => {
    navigate('/robes'); // Changez le chemin si nécessaire
  };
  ...
  return (
    <section className="py-20 bg-secondary-dark from-blue-100 to-purple-100">
      <div className="container mx-auto">
        <h2 className="text-4xl font-extrabold text-center mb-12 text-black font-sans">Nos robes</h2>
        ...
        <div className="block md:hidden mb-8 px-4 text-center">
          <p className="text-lg font-medium text-gray-900 mb-4 font-sans">
            Découvrez notre collection exclusive de robes conçues pour allier confort et élégance. Faites défiler pour voir nos modèles les plus populaires !
          </p>
        </div>
