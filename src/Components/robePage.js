...
const Nosrobes = () => {
  ...
  const culottes = [
    { id: 1, name: 'Robe Élégante', price: '12000f', description: 'Culotte élégante et confortable pour un style raffiné.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVjFE0B9Itj_vTSTXcXeCLd-gzle6ShzVkYw&s' },
    { id: 2, name: 'Robe Moderne', price: '15000f', description: 'Design moderne avec une coupe parfaite.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVjFE0B9Itj_vTSTXcXeCLd-gzle6ShzVkYw&s' },
    // Ajoutez plus de robes ici
  ];

  return (
    <section className="py-8 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-extrabold text-center mb-6 text-gray-900">Nos robes</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-2 gap-4">
          {culottes.map((culotte) => (
            <div key={culotte.id} className="bg-white p-4 rounded-lg shadow-md flex flex-col items-center transition-transform transform hover:scale-105 max-w-xs mx-auto">
              <img
                src={culotte.image}
                alt={culotte.name}
