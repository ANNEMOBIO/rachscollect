...
const PantalonsPage = () => {
  ...
  const culottes = [
    { id: 1, name: 'Pantalon Tiara', price: '12000f', description: 'Pantalon élégant et confortable pour un style raffiné.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVjFE0B9Itj_vTSTXcXeCLd-gzle6ShzVkYw&s' },
    { id: 2, name: 'Pantalon Mode', price: '15000f', description: 'Design moderne avec une coupe parfaite.', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVjFE0B9Itj_vTSTXcXeCLd-gzle6ShzVkYw&s' },
  ...
  return (
    <section className="py-8 bg-gray-100">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl font-extrabold text-center mb-6 text-gray-900">Nos pantalons</h2>
